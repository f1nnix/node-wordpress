...
function Client( settings ) {
	...
	var parsedUrl = Client.parseUrl( settings.url, settings.rpcPath );
...
Client.parseUrl = function( wpUrl, rpcPath ) {
	var urlParts, secure;
	...
	return {
		...
		path: rpcPath? rpcPath : urlParts.path.replace( /\/+$/, "" ) + "/xmlrpc.php",
		secure: secure
	};
};
